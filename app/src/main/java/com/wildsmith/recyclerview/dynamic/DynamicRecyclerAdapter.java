...
/**
 * Handles the inflation of {@link DynamicRecyclerModelView}s
 */
public class DynamicRecyclerAdapter<M extends DynamicRecyclerModel, V extends DynamicRecyclerModelView>
    extends RecyclerAdapter<M, V, DynamicRecyclerViewHolder<M, V>> {
    ...
    public DynamicRecyclerViewHolder<M, V> onCreateViewHolder(ViewGroup parent, int viewType) {
        return new DynamicRecyclerViewHolder<>(LayoutInflater.from(parent.getContext()).inflate(viewType, parent, false), getListener());
    }
